# Generated by Django 4.2.11 on 2025-09-05 19:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('actor', 'Actor'), ('director', 'Director'), ('writer', 'Writer'), ('producer', 'Producer'), ('composer', 'Composer'), ('cinematographer', 'Cinematographer'), ('editor', 'Editor'), ('designer', 'Designer'), ('voice_actor', 'Voice Actor')], max_length=50, verbose_name='role')),
                ('created', models.DateTimeField(auto_now_add=True)),
